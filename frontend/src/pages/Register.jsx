...
export default function Register() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center animate-fade-in py-12 px-4 relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-brand-accent1/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen"></div>
      ...
      <div className="glass-panel p-10 sm:p-14 w-full max-w-lg relative z-10 border-white/10 shadow-[0_0_80px_rgba(0,0,0,0.8)]">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-black mb-3 text-white">Create Account</h2>
          <p className="text-white/50 font-medium">Join HaveYourSeat to book tickets instantly</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative group">
              ...
              <div className="relative flex items-center">
                <User className="absolute left-4 text-white/40 group-focus-within:text-brand-accent1 transition-colors" size={20} />
                <input 
                  type="text" 
          ...
          <div>
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-accent1 to-brand-accent2 rounded-xl opacity-0 group-focus-within:opacity-100 blur-[2px] transition-opacity duration-300"></div>
              <div className="relative flex items-center">
                <Mail className="absolute left-4 text-white/40 group-focus-within:text-brand-accent1 transition-colors" size={20} />
                <input 
                  type="email" 
                  className="w-full bg-[#111] border border-white/10 rounded-xl py-4 pl-12 pr-4 text-white placeholder-white/20 focus:outline-none focus:bg-[#1a1a1a] transition-all"
          ...
          <div>
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-accent1 to-brand-accent2 rounded-xl opacity-0 group-focus-within:opacity-100 blur-[2px] transition-opacity duration-300"></div>
              <div className="relative flex items-center">
                <Lock className="absolute left-4 text-white/40 group-focus-within:text-brand-accent1 transition-colors" size={20} />
                <input 
        ...
        <p className="text-center mt-8 text-white/40">
          ...
          <Link to="/login" className="text-white font-bold hover:text-brand-accent1 transition-colors underline-offset-4 hover:underline">
            Sign in
          </Link>
        </p>
      </div>
